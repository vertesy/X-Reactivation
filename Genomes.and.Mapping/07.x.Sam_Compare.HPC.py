...
# Manually run in bash --------------------
# mkdir pat mat Allelic_SAMs
# mv *.pat.sam pat/
# mv *.mat.sam mat/


# Setup ----------------------
SamDir = "./X_inact/SAM5_OldTrimmed_long/RefSeq/"
ref_name1 = "pat"
ref_name2 = "mat"
...
pDir = SamDir+ref_name1; print (pDir)
mDir = SamDir+ref_name2
if not os.path.exists(LogDir):	os.makedirs(LogDir)

# # Copy files ------------------------------------------------
# if not os.path.exists(pDir):	os.makedirs(pDir)
# if not os.path.exists(mDir):	os.makedirs(mDir)
# files = glob.iglob(os.path.join(SamDir, "*.pat.sam"))
# for file in files:
# 	if os.path.isfile(file):
# 		shutil.copy2(file, pDir)

# files = glob.iglob(os.path.join(SamDir, "*.mat.sam"))
# for file in files:
# 	if os.path.isfile(file):
# 		shutil.copy2(file, pDir)
